...
classdef (InferiorClasses = {?quaternion}) octonion
    ...
    methods
        ...
        % Two arguments   - returns an octonion, two cases are supported:
        %                   1. the first argument is numeric and the second
        %                      is a pure octonion, with the same size and
        %                      the elements of the pure octonion must have
        %                      the same class as the scalar;
        %                   2. both arguments are quaternions of the same
        %                      size, with elements of the same class.
        ...
        switch nargin
            ...
            case 2
                ...
                % Check for same sizes, regardless of which case we are
                % handling (scalar + pure octonion, or two quaternions).
                ...
                if isnumeric(a0) && isa(a1, 'octonion')
                    ...
                    % part, and thus numeric, and the second must be the
                    % vector part, and thus a pure octonion (with the same
                    % component class as the first argument).
                ...
                elseif isa(a0, 'quaternion') && isa(a1, 'quaternion')
                    ...
                    % But the first quaternion argument may be pure, and we
                    % make a pure octonion (because the second quaternion
                    % argument must be full, due to the preceding check).
                    c0 = class(x(a0));
                    c1 = class(x(a1));
                    if strcmp(c0, c1)
                    ...
                    error(['Parameters must be numeric + pure octonion,', ...
                           ' or two quaternions.']);
                end
...
% $Id: octonion.m 1056 2020-02-17 20:42:58Z sangwine $
