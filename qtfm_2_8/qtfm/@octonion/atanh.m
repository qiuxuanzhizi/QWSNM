...
if isreal(X)
    ...
    % X is a real octonion, and we compute the inverse hyperbolic tangent
    ...
    Y = isooctonion(atanh(isocomplex(X)), X);
else
    ...
    error('octonion/atanh is not yet implemented for complex octonions');
end

% $Id: atanh.m 1053 2020-02-17 18:13:03Z sangwine $
